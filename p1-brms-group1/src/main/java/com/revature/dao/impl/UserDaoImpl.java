...
public class UserDaoImpl implements UserDao {
	...
	public void save(User user) {
		...
		try {
			...
			preparedStatment = connection.prepareStatement(Constant.INSERT_USER);
	...
	public void update(String userId, User newUser) {
		...
		try {
			...
			preparedStatment = connection.prepareStatement(Constant.UPDATE_USER);
	...
	public void remove(String userId) {
		...
		try {
			...
			preparedStatment = connection.prepareStatement(Constant.DELETE_USER);
	...
	public List<User> allUsers() throws SQLException {
		...
		try {
			connection = ConnectionFactory.getConnection();
			preparedStatment = connection.prepareStatement(Constant.SELECT_ALL_USER);
			rs = preparedStatment.executeQuery();
			while (rs.next()) {
